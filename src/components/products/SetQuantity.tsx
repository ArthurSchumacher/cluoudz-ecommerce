...
function SetQuantity({
  ...
  return (
    <div className="flex gap-4 items-center">
      ...
      <div className="flex gap-4 items-center justify-center max-w-[95px] text-base border border-content2 bg-background sm:p-2 p-1 rounded-md hover:border-foreground">
