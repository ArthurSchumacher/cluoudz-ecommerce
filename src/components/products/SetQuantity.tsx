...
function SetQuantity({
  ...
  return (
    <div className="flex gap-4 items-center">
      ...
      <div className="flex gap-4 items-center justify-center max-w-[95px] text-base border border-content1 bg-content2 sm:p-2 p-1 rounded-md hover:border-foreground">
