...
const signUpSchema = z.object({
  ...
  cpf: z.string().min(11, { message: "You must provide a valid CPF/CNPJ." }),

  phone: z.string().min(11, { message: "You must provide a valid phone." }),
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="gap-y-4 flex flex-col">
      ...
      <Controller
        ...
        render={({ field: { onChange, value } }) => (
          ...
          >
            Concordo com os{" "}
            <Link className="text-sm" href={paths.home()}>
              termos e condições
            </Link>
          </Checkbox>
        )}
